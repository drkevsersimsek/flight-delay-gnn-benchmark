...
obj = torch.load("pyg_dataset_hourly.pt", weights_only=False)
...
torch.save(mlp.state_dict(), "mlp_hourly_model.pt")
torch.save(gcn.state_dict(), "gcn_hourly_model.pt")
torch.save(gat.state_dict(), "gat_hourly_model.pt")
print("\nModeller kaydedildi: mlp_hourly_model.pt, gcn_hourly_model.pt, gat_hourly_model.pt")
