...
obj = torch.load("pyg_dataset_temporal.pt", weights_only=False)
...
torch.save(mlp.state_dict(), "mlp_temporal_model.pt")
torch.save(gcn.state_dict(), "gcn_temporal_model.pt")
torch.save(gat.state_dict(), "gat_temporal_model.pt")
print("\nModeller kaydedildi: mlp_temporal_model.pt, gcn_temporal_model.pt, gat_temporal_model.pt")
